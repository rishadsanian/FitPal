INSERT INTO log (exercise_name, exercise_id, session_id, user_id, resistance, reps, timestamp) VALUES
  ...
  ('Dumbbell Bench Press', 1, 1, 3, 60, 10, NOW() - INTERVAL '4 days'),
  ('Dumbbell Flyes', 2, 1, 3, 45, 12, NOW() - INTERVAL '3 days'),
  ('Smith machine shrug', 7, 1, 3, 80, 8, NOW() - INTERVAL '2 days'),
  ('Incline dumbbell bench press', 3, 2, 3, 55, 10, NOW() - INTERVAL '1 day'),
  ('Low-cable cross-over', 4, 2, 3, 50, 12, NOW() - INTERVAL '1 day'),
  ('Leverage Shrug', 8, 2, 3, 90, 6, NOW() - INTERVAL '1 day'),
  ('Dumbbell Bench Press', 1, 3, 3, 65, 8, NOW() - INTERVAL '1 day'),
  ('Standing dumbbell shrug', 9, 3, 3, 70, 10, NOW() - INTERVAL '1 day'),
  ('Kettlebell sumo deadlift high pull', 11, 3, 3, 35, 15, NOW() - INTERVAL '1 day');
