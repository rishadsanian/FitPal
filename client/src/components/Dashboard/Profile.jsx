        ...
        <div className="col-md-6">
          <div className="card bg-dark text-white">
            ...
            <div className="card-body p-3 pt-0">
              ...
              <div className="mb-3">
                <label htmlFor="date_of_birth" className="form-label text-secondary text-start">
                  Date of Birth:
                </label>
                <input
                  type="date"
              ...
              <div className="mb-3">
                <label htmlFor="height" className="form-label text-secondary text-start">
                  Height:
                </label>
                <input
                  type="number"
              ...
              <div className="mb-3">
                <label htmlFor="weight" className="form-label text-secondary text-start">
                  Weight:
                </label>
                <input
                  type="number"
              ...
              <div className="mb-3">
                <label htmlFor="gender" className="form-label text-secondary text-start">
                  Gender:
                </label>
                <select
              ...
              <div className="mb-3">
                <label htmlFor="fitness_level" className="form-label text-secondary text-start">
                  Fitness Level:
                </label>
                <select
                  className="form-select"
              ...
              <div className="mb-3">
                <label htmlFor="goal" className="form-label text-secondary text-start">
                  Goal:
                </label>
                <input
                  type="text"
